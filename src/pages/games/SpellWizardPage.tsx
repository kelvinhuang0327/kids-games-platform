...
const WORDS: Word[] = [
  ...
  { word: 'LION', hint: '叢林之王', category: '動物' },
  { word: 'TIGER', hint: '有條紋的大貓', category: '動物' },
  { word: 'BEAR', hint: '喜歡吃蜂蜜的動物', category: '動物' },
  { word: 'RABBIT', hint: '有長耳朵會跳的動物', category: '動物' },
  { word: 'ELEPHANT', hint: '有長鼻子的大動物', category: '動物' },
  { word: 'GRAPE', hint: '紫色一串串的水果', category: '水果' },
  { word: 'LEMON', hint: '黃色酸酸的水果', category: '水果' },
  { word: 'MANGO', hint: '熱帶黃色的水果', category: '水果' },
  { word: 'CHAIR', hint: '用來坐的家具', category: '物品' },
  { word: 'TABLE', hint: '用來吃飯寫字的家具', category: '物品' },
  { word: 'DOOR', hint: '進出房間要打開的', category: '物品' },
  { word: 'WINDOW', hint: '可以看到外面的', category: '物品' },
  { word: 'CAR', hint: '四個輪子的交通工具', category: '交通' },
  { word: 'BUS', hint: '可以載很多人的車', category: '交通' },
  { word: 'TRAIN', hint: '在鐵軌上跑的交通工具', category: '交通' },
  { word: 'PLANE', hint: '在天空飛的交通工具', category: '交通' },
  { word: 'RAIN', hint: '從天上掉下來的水', category: '自然' },
  { word: 'CLOUD', hint: '天空中白白的', category: '自然' },
  { word: 'WIND', hint: '吹動樹葉的力量', category: '自然' },
  { word: 'SNOW', hint: '冬天從天上飄下來的白色', category: '自然' },
]
